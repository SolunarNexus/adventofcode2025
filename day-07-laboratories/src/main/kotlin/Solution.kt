...
class Solution {
    ...
    fun quantumBeamSplitSum(): Long {
        ...
        return propagateQuantumBeam(input, cache, startX, startY)
    }
    ...
    private fun propagateQuantumBeam(
        manifold: List<String>, cache: MutableMap<Pair<Int, Int>, Long>, x: Int, y: Int
    ): Long {
