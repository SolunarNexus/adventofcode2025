...
present with shape index 0, no presents with shape index 1, one present with shape index 2, no presents with shape index
...
needs to fit one additional present with shape index `4`. Unfortunately, no matter how hard you try, there is 
