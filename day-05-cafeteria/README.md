...
As the forklifts break through the wall, the Elves are delighted to discover that there was a cafeteria
...
they can't figure out which of their ingredients are **fresh** and which are **spoiled**. When you ask how it works, they give
...
So that they can stop bugging you when they get new inventory, the Elves would like to know **all** of the IDs that 
**the fresh ingredient ID ranges** consider to be **fresh**. An ingredient ID is still considered fresh if it is in any range.
...
`17`, `18`, `19`, and `20`. So, in this example, the fresh ingredient ID ranges consider a total of `14` ingredient IDs to be fresh.
